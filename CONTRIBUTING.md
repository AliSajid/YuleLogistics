...
<!-- omit in toc -->
# Contributing to Yule Logistics
...
Before you ask a question, it's best to search for existing [Issues](https://github.com/${gh_user}/${project-name}/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It's also advisable to search the internet for answers first.
...
- Make sure that you are using the latest version.
- Perform a [search](https://github.com/AliSajid/yule-logistics/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Find out whether your idea fits with the scope and aims of the project. It's up to you to make a strong case to convince the project's developers of the merits of this feature. Keep in mind that we want features that will be useful to the majority of our users and not just a small subset. If you're just targeting a minority of users, consider writing an add-on/plugin library.

<!-- omit in toc -->
#### How Do I Submit a Good Enhancement Suggestion?

Enhancement suggestions are tracked as [GitHub issues](https://github.com/AliSajid/yule-logistics/issues).
...
Please [open an issue](https://github.com/AliSajid/yule-logistics/issues) to let the team know that of your interest in joining, and we can discuss the details in the issue.
